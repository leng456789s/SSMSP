...
<%--       %>--%>
       <div style="width: 50%;margin-left: 25%;margin-top: 1%">
            ...
            <form   action="/goods/add" method="post" enctype="multipart/form-data">
                <label>商品名称：</label><input class="form-control" type="text" id="name" name="name"><br/>
                <label>类   别：</label>
...
<%--                    <option selected="selected" value="0">奶茶</option>--%>
                ...
                <label>价   格：</label><input class="form-control" type="text" id="price1" name="price1"><br/>
                <label>库存数量：</label><input class="form-control" type="text" id="num" name="num"><br/>
                <label>商品简介：</label><textarea class="form-control"  id="info" name="info" rows="2" resize="none"></textarea>
                <label>图   片：</label><br/>
                <div class="grid-container" style="border: white 2px solid;">
                    <div style="border: red 1px solid;text-align: center">
                          <img id="pic" src="/img/14.jpg" class="img-thumbnail" style="width: 180px;height: 180px">
                    </div>
                    <div style="border: black 1px solid;text-align: right">
                          <input  type="file" name="fileName" id="img-upload" style="display: none">
                ...
                <div style="text-align: right;margin-top: 6px;" >
                        ...
                        <input  id="button2" type="submit" value="添加" class="btn btn-info">
...
<script>
    ...
    $("#img-upload").change(function () {
        ...
        if (window.createObjectURL !== undefined) {//当文件对象不是未定义
            url = window.createObjectURL(fileObj); //此时创建一个URL地址
